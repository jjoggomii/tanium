			...
			<form id="insertForm" name="insertForm" method="post">
				<div class="col-lg-12" style="margin-top: 25%; margin-left: 4%;">
					...
					<div class="card mb-3" style="width: 200%;"	>
						...
						<div class="card-body">
							<p class="card-text">
								<textarea cols="50" rows="13" id=ntcontent name="ntcontent" style="width: 100%;" ></textarea>
							</p>
						</div>
					</div>
					<table>
						<tr>
							<td><input type=submit class="btn btn-primary" value="작성하기" id="ntsubmit"/></td>
							<td><input type=button class="btn btn-primary" value="취소" id="back" /></td>
						</tr>
					</table>
				</div>
			</form>
