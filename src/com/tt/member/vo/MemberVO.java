package com.tt.member.vo;
	...
	public MemberVO(String mbno, String mbname, String mbpw, String mbgender,
			...
			int mbpostcode, String mbhobby, String mbmarry, String mbjoindate,
	...
	public int getMbpostcode() {
		return mbpostcode;
	}
	public void setMbpostcode(int mbpostcode) {
		this.mbpostcode = mbpostcode;
	}
